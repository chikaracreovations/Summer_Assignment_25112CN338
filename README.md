...
*Status: 🟢 Completed*
- [x] **Q1:** Calculate sum of first N natural numbers `[TCS, Infosys, Wipro]`✅
- [x] **Q2:** Print multiplication table of a given number `[TCS, Infosys, Wipro]`✅
- [x] **Q3:** Find factorial of a number `[TCS, Infosys, Wipro]`✅
- [x] **Q4:** Count digits in a number `[TCS, Infosys, Wipro]`✅
